...
params_ <- list(
    ...
    v_ab_names_ref = c("D"),                      # absorbing health states (traditional approach)
    ...
    v_s0T_ref = c(1,0,0,0),                    # initial state occupancy (traditional approach)
  ...
  m_P = 
    ages %>% map(~({
     ...
     mP_SoC = 
          ...
          ncol = n_states0,
          byrow=TRUE, 
          dimnames = list(c(v_tr_names,v_ab_names_ref),
                          c(v_tr_names,v_ab_names_ref)
          ))
      ...
      array(c(as.vector(mP_SoC),
              ...
              as.vector(mP_B),
              as.vector(mP_AB)), 
            dim = c(length(v_tr_names)+ length(v_ab_names_ref),length(v_tr_names)+ length(v_ab_names_ref),length(v_tx_names)),
            dimnames = list(c(v_tr_names,v_ab_names_ref),c(v_tr_names,v_ab_names_ref),v_tx_names)) %>% 
